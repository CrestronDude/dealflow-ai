  ...
  return (
    <main style={{ fontFamily: "'Georgia',serif", background: '#0a0e0a', color: '#e8f0e8', minHeight: '100vh' }}>
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 2rem', borderBottom: '1px solid #1a2e1a' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', fontFamily: 'system-ui, sans-serif' }}>
          <span style={{ fontSize: '0.8rem', color: '#4d7a4d' }}>3 free analyses</span>
          <Link href="/auth/signup" style={{ background: '#16a34a', color: 'white', padding: '0.4rem 1rem', borderRadius: '6px', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 600 }}>
            Sign Up Free
          </Link>
        </div>
      </nav>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '2.5rem 2rem' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', color: '#4d7a4d', fontSize: '0.8rem', fontFamily: 'system-ui,sans-serif' }}>
          ...
          <Link href="/#pricing" style={{ color: '#4ade80' }}>Upgrade to Pro →</Link>
        </p>
      </div>
    </main>
  )
